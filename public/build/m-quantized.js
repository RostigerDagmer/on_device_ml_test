...
export function cosine_similarity(a, b) {
    const ret = wasm.cosine_similarity(addHeapObject(a), addHeapObject(b));
    return ret;
}
...
const ModelConditionalGenerationFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_modelconditionalgeneration_free(ptr >>> 0));
/**
*/
export class ModelConditionalGeneration {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ModelConditionalGenerationFinalization.unregister(this);
        return ptr;
    }
...
const ModelEncoderFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_modelencoder_free(ptr >>> 0));
/**
*/
export class ModelEncoder {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ModelEncoderFinalization.unregister(this);
        return ptr;
    }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_51a708843e974d75 = function(arg0, arg1) {
